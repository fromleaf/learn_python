eStructuredText (rst): plain text markup
					   =========================================
...
variety of ways. Any section and subsections defined can be linked to,
		...
		The magnetisation in a small ferromagnetic disk. The diametre is of the order of 120 nanometers and the
		material is Ni20Fe80. Png is a file format that is both acceptable for html pages as well as for
		(pdf)latex.
