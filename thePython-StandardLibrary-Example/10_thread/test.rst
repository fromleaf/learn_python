s is a comment. Note how any initial comments are moved by
...
.. bibliographic fields (which also require a transform):
	...
	incorporate, collate, fold, staple, or
	mutilate it, or do
	anything else to it that
	your or anyone else's heart
	desires.
	:field name:
	This is a
	generic
	...
	*re*\
		...
		*Text*.
		...
		--including
		some--
		strangely--hyphenated-words.
		Adjust-the-width-of-your-browser-window
		to
		see
		how
		the
...
#. List items may also be auto-enumerated.
	...
	database
	records.  They are often part of an extension
	syntax.  They are
	an unambiguous variant of RFC 2822 fields.

	:how arg1 arg2:

	The field marker is a colon, the field
	name, and a colon.

	The field body may contain one or
	more body elements, indented
...
(cut and pasted from interactive Python sessions)
	...
	An image directive (also clickable -- a hyperlink reference):
		...
		.. Tip:: 15% if the service
		is good.

		.. WARNING:: Strong prose may
		provoke extreme mental
		exertion.
